...
local RECYCLEMANAGER_BUTTONFUNC_ID_13 = 13  --打开主界面
...
function RecycleManager.ShowRecycleEnterUI(actor)
    local sPanelStr = '<Img|x=173.0|y=154.0|show=0|loadDelay=1|reset=1|bg=1|move=0|esc=1|img=private/cc_recycle/7.png>'..
        ...
        '<Button|x=239.0|y=250.0|nimg=private/cc_recycle/9.png|pimg=private/cc_recycle/9.png|mimg=private/cc_recycle/9.png|color=255|size=18|link=@recyclemanager_button, '..RECYCLEMANAGER_BUTTONFUNC_ID_10..'>'..
        '<Button|x=399.0|y=250.0|nimg=private/cc_recycle/11.png|pimg=private/cc_recycle/11.png|mimg=private/cc_recycle/11.png|color=255|size=18|link=@recyclemanager_button, '..RECYCLEMANAGER_BUTTONFUNC_ID_11..'>'
...
function RecycleManager.ShowRecyclePanelInfo(actor)    
    ...
    local msg = '<Img|id=200|children={'..childidstr..'}|x=22.0|y=51.0|move=1|loadDelay=0|show=0|bg=1|img='..backpic..'|esc=1|reset=1>'..
        '<Layout|id=201|x=688.0|y=20.0|width=80|height=80|link=@recyclemanager_button, '..RECYCLEMANAGER_BUTTONFUNC_ID_13..'>'..
        '<Button|id=202|x=688.0|y=20.0|pimg=public/1900000511.png|nimg=public/1900000510.png|link=@recyclemanager_button, '..RECYCLEMANAGER_BUTTONFUNC_ID_13..'>'    
    ...
    msg = msg..'<CheckBox|x='..tempx..'|y='..tempy..'|id=214|nimg=private/cc_common/checkbox_1.png|pimg=private/cc_common/checkbox_2.png|checkboxid='..AUTO_RECYCLE_CHECKBOX_TEMPVAR..
        '|default='..tempflag..'|delay=0|count=1|link=@recyclemanager_button,'..RECYCLEMANAGER_BUTTONFUNC_ID_5..'>'
    ...
    msg = msg..'<Button|id=210|x=95.0|y=375.0|nimg=private/cc_recycle/13.png|mimg=private/cc_recycle/13.png|color=255|pimg=private/cc_recycle/13.png|size=18|link=@recyclemanager_button,'..RECYCLEMANAGER_BUTTONFUNC_ID_1..'>'..
        '<Button|id=211|x=240.0|y=375.0|nimg=private/cc_recycle/14.png|mimg=private/cc_recycle/14.png|color=255|pimg=private/cc_recycle/14.png|size=18|link=@recyclemanager_button,'..RECYCLEMANAGER_BUTTONFUNC_ID_2..'>'..
        '<Button|id=212|x=380.0|y=375.0|nimg=private/cc_recycle/15.png|mimg=private/cc_recycle/15.png|color=255|pimg=private/cc_recycle/15.png|size=18|link=@recyclemanager_button,'..RECYCLEMANAGER_BUTTONFUNC_ID_3..'>'..
        '<Button|id=213|x=525.0|y=375.0|nimg=private/cc_recycle/16.png|mimg=private/cc_recycle/16.png|color=255|pimg=private/cc_recycle/16.png|size=18|link=@recyclemanager_button,'..RECYCLEMANAGER_BUTTONFUNC_ID_4..'>'
...
function RecycleManager.ShowRecyclePriceInfo(actor)
    ...
    local msg = '<Img|id=200|children={'..childidstr..'}|x=22.0|y=51.0|move=1|loadDelay=0|show=0|bg=1|img='..backpic..'|esc=1|reset=1>'..
        '<Layout|id=201|x=688.0|y=20.0|width=80|height=80|link=@recyclemanager_button, '..RECYCLEMANAGER_BUTTONFUNC_ID_12..'>'..
        '<Button|id=202|x=688.0|y=20.0|pimg=public/1900000511.png|nimg=public/1900000510.png|link=@recyclemanager_button, '..RECYCLEMANAGER_BUTTONFUNC_ID_12..'>' 
...
function RecycleManager.ShowActivatedAutoRecyclePanel(actor)
    local sPanelStr = '<Img|x=173.0|y=154.0|reset=1|loadDelay=1|img=private/cc_recycle/24.png|esc=1|show=0|move=0|bg=1>'..
        '<Button|x=566.0|y=156.0|pimg=public/1900000511.png|nimg=public/1900000510.png|link=@recyclemanager_button,'..RECYCLEMANAGER_BUTTONFUNC_ID_12..'>'..        
        '<Button|x=566.0|y=156.0|pimg=public/1900000511.png|nimg=public/1900000510.png|link=@recyclemanager_button,'..RECYCLEMANAGER_BUTTONFUNC_ID_12..'>'..
        '<Button|x=235.0|y=295.0|nimg=private/cc_common/button_1.png|pimg=private/cc_common/button_1.png|color=255|size=18|mimg=private/cc_common/button_1.png|text=100元宝购买|link=@recyclemanager_button, '..RECYCLEMANAGER_BUTTONFUNC_ID_15..'>'..
        '<Button|x=405.0|y=295.0|nimg=private/cc_common/button_1.png|pimg=private/cc_common/button_1.png|color=255|size=18|mimg=private/cc_common/button_1.png|text=前往提升|link=@recyclemanager_button, '..RECYCLEMANAGER_BUTTONFUNC_ID_14..'>'..
...
function RecycleManager.DoOperButton(actor, sid)
    ...
    elseif funcid == RECYCLEMANAGER_BUTTONFUNC_ID_12 then
        RecycleManager.ShowRecyclePanelInfo(actor)
    elseif funcid == RECYCLEMANAGER_BUTTONFUNC_ID_13 then
